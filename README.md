...
1. Clone the repo: `git clone https://github.com/armentanoc/backend-dev-portfolio.git`
1. `cd backend-dev-portfolio`
...
## Notes
 ...
 - Search is based on [Fuse.js](https://fusejs.io) and [vue-fuse](https://github.com/shayneo/vue-fuse). It only searches the title and summary of posts for now. Some tweaking may be necessary to get it to search to your liking. Check out the fuse documentation for search settings. 
